...
//this seems to avoid the repetition in the same memory access
...
static int __cmd_report(struct report *rep)
{
	...
	printf("\n ** %ld \n",  (long) offsetof(struct hist_entry, mem_info));
	if (rep->cpu_list) {
	...
	evlist__for_each(session->evlist, pos3)
		; 
	...
	//makes some searches related to kernel symbols
	...
	//consolidate entries with the same indo?
